...
Definitions of terms used in this course. Some of these terms have a more broad meaning in computer science, others have multiple meanings. But for clarity the definition given below is restricted to the way in which we use the term in this course.

## Contents

- [Abstract (verb)](#abstract-verb)
- [Accumulator](#accumulator)
- [Arbitrary Sized](#arbitrary-sized)
- [Argument](#argument)
...
- [Lambda](#lambda)
- [List](#list)
- [Mixed Data Itemization](#mixed-data-itemization)
...
- [Predicate](#predicate)
- [Primitive](#primitive)
- [Program Domain (aka Problem Domain)](#program-domain-aka-problem-domain)
- [Purpose](#purpose)
- [Recursion](#recursion)
...
An argument is a value that passed to a function or a primitive operation when it is called. The arguments are the values that result from evaluating the operands in the function or primitive call. See [parameter](#parameter) for a discussion of the differences between operands, arguments and parameters.
